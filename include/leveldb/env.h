...
class LEVELDB_EXPORT SequentialFile {
 public:
  ...
  // ReadRecord up to "n" bytes from the file.  "scratch[0..n-1]" may be
...
class LEVELDB_EXPORT RandomAccessFile {
 public:
  ...
  // ReadRecord up to "n" bytes from the file starting at "offset".
...
class LEVELDB_EXPORT WritableFile {
 public:
  ...
  virtual Status Fallocate(uint64_t offset, size_t len) = 0;
};
...
class LEVELDB_EXPORT Logger {
 public:
  ...
  // WriteRecord an entry to the log file with the specified format.
